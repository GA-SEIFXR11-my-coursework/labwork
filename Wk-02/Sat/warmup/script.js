const thisArray = ["Skynet","Digital Music Distribution",
...
const thatArray = ["Facebook Platform","Erlang Enthusiasts","Ex-Girlfriends",
...
function button(){
    document.getElementById("ideaOutput").textContent = 
        (`${randomItem(thisArray)} for ${randomItem(thatArray)}`);
    return;
}