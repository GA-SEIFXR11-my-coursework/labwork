...
function convertPhoneNumber(baseNum, word) {
    var paddedNumber = "";
    for (let c of word) {
...
console.log("convertPhoneNumber('1300', 'FLOWERS') expect '1300356937' -> ", convertPhoneNumber('1300', 'FLOWERS'));
console.log();
console.log("convertPhoneNumber('1800', 'GOTJUNK') expect '1800468586' -> ", convertPhoneNumber('1800', 'GOTJUNK'));
