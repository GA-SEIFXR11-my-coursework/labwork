...
// your code
var { name: recipeName, prepTime: recipePrepTime, servingSize, cookingTime, } = recipe;
var { name: lessonName, prepTime: lessonPrepTime, } = lesson;
...
var { id: catId, title, url: gifUrl, rating: catRating, } = catGif;
...
var { height: originalHeight, width: originalWidth, } = catGif.images.original;
...
var { height: dsHeight, width: dsWidth, } = catGif.images.downsized;
...
function printMyFavoriteColors(...colors) {
    let [a, b, c] = colors;
    console.log({ a, b, c });
