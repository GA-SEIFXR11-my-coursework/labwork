...
console.log(
  "an array of the years of birth for each horse.",
  horses.map(function(val){
...
console.log(
  "filter in only the active horses.",
  horses.filter(function(val){
    return val["active"]
  })
)
...
console.log(
  "total number of hours worked by all horses collectively.",
  horses.reduce(function(accumulator, next){
...
console.log(
  "horses that earn $50 or more per hour",
  horses.filter(function(val){
...
console.log(
  "a list of the totals earned by each horse.",
  horses.map(function(val){
...
console.log(
  "calculate the total earned by all horses combined.",
  horses
    .map(function(val){
      return(val["hourlyRate"] * val["numOfHoursWorked"])
    })
