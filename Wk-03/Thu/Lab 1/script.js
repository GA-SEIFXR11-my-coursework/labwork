...
function f_area(width, length) {
    return (width * length);
}
//Extension: Write using both function and arrow syntax
var af_area = function (width, length) { return width * length; };
...
function helloIn(lang) {
    switch (lang.toLowerCase()) {
        ...
        case "german":
            ...
            break;
        default:
            console.log("Sorry, I do not speak ".concat(lang));
            break;
    }
}
